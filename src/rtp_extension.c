 ...
 */
  void
    set_extension (RtpExtension_t * rtp_extension, uint16_t type,
		   uint32_t * words, uint16_t length)
  {
 ...
 **/
  void *rtp_extension_to_uint32_t (RtpExtension_t * extension)
  {
    ...
    uint32_t *extension_buf =
      (uint32_t *) malloc (sizeof (uint32_t) * (extension->length + 1));
