 ...
 **/
mblk_t *
rtp_session_create_packet_with_extension(RtpSession * session, int header_size,
    const uint8_t * payload, int payload_size, RtpExtension_t * extension)
{
 ...
 */
mblk_t *
rtp_session_create_packet_with_data_with_extension(RtpSession * session,
    uint8_t * payload, int payload_size, void
    (*freefn)

    (void *), RtpExtension_t * extension)
{
  mblk_t *mp, *mpayload;
 ...
 **/
int
rtp_session_recv_with_ts_with_extension(RtpSession * session, uint8_t * buffer,
